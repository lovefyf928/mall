  ...
  <div id="Login_modify">
    ...
    <div class="content" :style="dis">
      ...
      <div class="text">
        ...
        <p style="text-align: center;padding-left: 8px;">设置新密码</p>
        <p style="text-align: right">完成</p>
      </div>

      <table style="margin-top: 60px;margin-bottom: 20px;">
        <p>手机号：</p>
        <input type="text" placeholder="请输入手机号码" disabled="disabled" v-model="$root.phone" style="width: 250px;height: 38px">
      </table>
      <table>
        <p>手机验证码：</p>
    ...
    <div class="content" :style="dis1">
      ...
      <div class="text">
        <p style="text-align: left;color: #41bbee">身份验证</p>
        <p style="text-align: center;padding-left: 8px;color:#41bbee;">设置新密码</p>
        <p style="text-align: right">完成</p>
      </div>
  ...
  export default {
    ...
    methods:{
      ...
      submitPassword:function(){
        ...
        this.$axios.post("http://api.eawsp.com/api/user/changePassword?token="+ sessionStorage.getItem("token"),{
